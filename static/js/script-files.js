...
var images = [
  "/static/assets/update up.svg",
  "/static/assets/update out.svg",
  "/static/assets/update yes.svg",
];
var index = 0;
...
function closePopup(containerId) {
  ...
  document.getElementById(
    "fileLabel"
  ).innerHTML = `<img class="fileLabel" src="/static/assets/update up.svg"><img src="/static/assets/update out.svg" class="fileLabel-1"  alt="Upload File"><span class="fileLabelText">Select a file...</span>`;
      ...
      if (usernameInput.value.length < 4) {
        ...
        if (isPrintableKey) {
          ...
          navigator.clipboard.readText().then((clipText) => {
            ...
            const newText = filteredText.slice(
              0,
              4 - usernameInput.value.length
            );
